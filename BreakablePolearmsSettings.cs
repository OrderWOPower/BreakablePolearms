...
namespace BreakablePolearms
{
    public class BreakablePolearmsSettings : AttributeGlobalSettings<BreakablePolearmsSettings>
    {
        ...
        [SettingPropertyInteger("{=BreakableOpt002}HP of Non-Swinging Polearms", 1, 100, "0", Order = 1, RequireRestart = false, HintText = "{=BreakableOpt002Hint}Multiplier for a non-swinging polearm's HP based on its handling. Default is 2.")]
        [SettingPropertyGroup("{=BreakableOptG001}Non-Swinging Polearms", GroupOrder = 0)]
        public int NonSwingingPolearmHitPointsMultiplier { get; set; } = 2;
        ...
        [SettingPropertyInteger("{=BreakableOpt004}HP of Swinging Polearms", 1, 100, "0", Order = 1, RequireRestart = false, HintText = "{=BreakableOpt004Hint}Multiplier for a swinging polearm's HP based on its handling. Default is 4.")]
        [SettingPropertyGroup("{=BreakableOptG002}Swinging Polearms", GroupOrder = 1)]
        public int SwingingPolearmHitPointsMultiplier { get; set; } = 4;
